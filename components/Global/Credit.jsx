...
const TOKEN_CREDIT = process.env.NEXT_PUBLIC_BUY_CREDIT;
    ...
    try {
      ...
      if (transaction.hash) {
        const res = await axios({
          ...
          withCredentials: true,
          data: {
            credit: Number(activeUser?.credit) + Number(TOKEN_CREDIT),
          },
        });
                          ...
                          <div className="flex flex-row items-start justify-between">
                            <div className="flex flex-col gap-1">
                              ...
                              <p className="font-base text-base-m font-medium text-base500">
                                Get your account verified and get a verified badge
                              </p>
                            </div>
                          </div>
